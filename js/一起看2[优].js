function verifyLogin(key) {
    ...
    let cookie = '';
    let content = '';
    let yzm_url = 'https://ruguojiaoyu.com/include/vdimgck.php';
    log(`验证码链接:${yzm_url}`);
    let submit_url = 'https://ruguojiaoyu.com/search.php?scheckAC=check&page=1&searchtype=&order=&tid=&area=&year=&letter=&yuyan=&state=&money=&ver=&jq=';
